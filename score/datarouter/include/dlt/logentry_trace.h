...
// The SPP_MEMCPY_SERIALIZABLE macro is part of the Tracing infrastructure and is tested independently.
...
// SPP_MEMCPY_SERIALIZABLE won't cause data loss.
// coverity[autosar_cpp14_a4_7_1_violation]
SPP_MEMCPY_SERIALIZABLE(score::common::visitor::payload_tags::text, DltidT)
// LCOV_EXCL_STOP
...
// The SPP_STRUCT_TRACEABLE macro is part of the Tracing infrastructure and is tested independently.
// This usage is declarative only and does not contain logic specific to this module.
// Excluding from coverage to avoid inflating coverage metrics with non-functional declarations.
// LCOV_EXCL_START : See above
// Suppress "AUTOSAR C++14 A18-9-4". The rule states: An argument to std::forward shall not be subsequently used.
// Rationale: SPP_STRUCT_TRACEABLE is a macro, std::forward is from the macro definition
...
// coverity[autosar_cpp14_m3_2_3_violation]
SPP_STRUCT_TRACEABLE(LogEntryFilter, app_id, ctx_id, log_level_threshold)
// LCOV_EXCL_STOP
