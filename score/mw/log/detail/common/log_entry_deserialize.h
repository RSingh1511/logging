...
- Maintaining compatibility and avoiding performance overhead outweighs POD Type (class) based design for this
  ...
  design. Moreover the type is used with SPP_STRUCT_TRACEABLE for serialization purpose
*/
...
// LCOV_EXCL_START
// SPP_STRUCT_TRACEABLE macro tested in score/serialization/serializer_test.cpp
...
Justification:
- we need to use SPP_STRUCT_TRACEABLE here and create an instance of LogEntryDeserializationReflection
...
SPP_STRUCT_TRACEABLE(LogEntryDeserializationReflection, app_id, ctx_id, serialized_vector_data, num_of_args, log_level)
// LCOV_EXCL_STOP
