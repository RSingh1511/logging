...
SPP_STRUCT_TRACEABLE(DisabledLoggerTestEntry, dummy)
}  // namespace test_data
...
SPP_STRUCT_TRACEABLE(NonVerboseMessage, bool_value)
SPP_STRUCT_TRACEABLE(DropCounterTestEntry, test_value)
