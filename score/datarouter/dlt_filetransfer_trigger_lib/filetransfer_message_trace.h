...
SPP_MEMCPY_SERIALIZABLE(score::common::visitor::payload_tags::text, score::platform::DltidT)
...
SPP_STRUCT_TRACEABLE(FileTransferEntry, appid, ctxid, file_name, delete_file)
